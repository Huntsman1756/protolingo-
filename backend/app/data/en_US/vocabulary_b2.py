...
B2_SETS: list[VocabularySet] = [
    ...
    VocabularySet(
        id="us_institutions_b2",
        level="B2",
        topic="American Institutions & Political Vocabulary",
        unit_ref="b2-unit-7",
        words=[
            VocabularyEntry(
                word="Congress",
                pos="noun",
                definition="The US federal legislature, consisting of the Senate and the House of Representatives.",
                example="Congress passed the bill with a large majority.",
                ipa="/ˈkɑːŋɡrəs/",
                frequency_rank=270,
            ),
            VocabularyEntry(
                word="Senate",
                pos="noun",
                definition="The upper chamber of the US Congress, with two senators per state.",
                example="The Senate voted to confirm the Supreme Court nominee.",
                ipa="/ˈsenɪt/",
                frequency_rank=280,
            ),
            VocabularyEntry(
                word="Supreme Court",
                pos="noun",
                definition="The highest court in the United States, which has the final say on constitutional questions.",
            ...
            VocabularyEntry(
                word="Medicare",
                pos="noun",
                definition="The US federal health insurance program for people aged 65 or older.",
                example="She became eligible for Medicare when she turned 65.",
                ipa="/ˈmedɪker/",
                frequency_rank=350,
            ),
            VocabularyEntry(
                ...
                pos="noun",
                definition="The constitutional right to freedom of speech, religion, press, assembly, and petition.",
                example="The court ruled that the protest was protected under the First Amendment.",
                ipa="/fɜːrst əˈmendmənt/",
                frequency_rank=360,
            ),
            VocabularyEntry(
                word="federal",
                pos="adjective",
                definition="Relating to the national (central) government as opposed to state or local government.",
                example="The federal government sets nationwide immigration policy.",
                ipa="/ˈfedərəl/",
                frequency_rank=280,
            ),
            VocabularyEntry(
                word="bipartisan",
                pos="adjective",
                definition="Involving cooperation between the two main political parties (Democratic and Republican).",
                example="The infrastructure bill passed with bipartisan support.",
                ipa="/ˌbaɪˈpɑːrtɪzən/",
                frequency_rank=370,
            ),
            VocabularyEntry(
                word="constituency",
                pos="noun",
                definition="A district whose residents elect a representative to the House of Representatives.",
                example="She campaigned hard in her constituency to win re-election.",
                ipa="/kənˈstɪtʃuənsi/",
                frequency_rank=380,
            ),
        ],
