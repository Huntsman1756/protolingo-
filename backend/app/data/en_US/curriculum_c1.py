...
C1_UNITS: list[CurriculumUnit] = [
    ...
    CurriculumUnit(
        ...
        competency_checklist=[
            ...
            "Recognize and produce emphasis structures in formal speeches and essays.",
    ...
    CurriculumUnit(
        ...
        competency_checklist=[
            ...
            "Analyze how cohesive devices contribute to text unity.",
    ...
    CurriculumUnit(
        ...
        competency_checklist=[
            ...
            "Pass a C1-level CEFR proficiency assessment covering all four skills.",
        ],
        default_weeks=1,
