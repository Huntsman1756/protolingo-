...
A1_SETS: list[VocabularySet] = [
    ...
    VocabularySet(
        id="british_greetings_a1",
        level="A1",
        topic="British English Greetings & Informal Vocabulary",
        unit_ref="a1-unit-1",
        words=[
            VocabularyEntry(
                word="Cheers",
            ...
            VocabularyEntry(
                word="Alright?",
                pos="phrase",
                definition="Informal British greeting meaning 'How are you?' or 'Hello'. Expects 'Yeah, alright!' in reply.",
                example="Alright? How's your day been?",
                ipa="/ɔːlˈraɪt/",
                frequency_rank=280,
            ),
            VocabularyEntry(
                word="lovely",
                pos="adjective",
                definition="Very pleasant or nice. Used far more in British English than American English.",
                example="What a lovely day! Shall we go for a walk?",
                ipa="/ˈlʌvli/",
                frequency_rank=290,
            ),
            VocabularyEntry(
                word="brilliant",
                pos="adjective",
                definition="Excellent, wonderful. Used as an informal intensifier in British English.",
                example="That film was absolutely brilliant!",
                ipa="/ˈbrɪljənt/",
                frequency_rank=310,
            ),
            VocabularyEntry(
                word="mate",
                pos="noun",
                definition="Informal British term for a friend; also used to address someone directly.",
                example="Have you met my mate Tom? We went to school together.",
                ipa="/meɪt/",
                frequency_rank=270,
            ),
            VocabularyEntry(
            ...
            VocabularyEntry(
                word="fancy",
                pos="verb",
                definition="To want or like something (informal British). 'Do you fancy...?' = Would you like...?",
            ...
            VocabularyEntry(
                word="fortnight",
                pos="noun",
                definition="A period of two weeks. Very common in British English; rarely used in American English.",
