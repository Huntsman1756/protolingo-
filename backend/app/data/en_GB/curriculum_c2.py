...
C2_UNITS: list[CurriculumUnit] = [
    ...
    CurriculumUnit(
        ...
        competency_checklist=[
            ...
            "Use the vocabulary of British social interaction (banter, self-deprecation, hedging) naturally.",
            "Analyse how context determines meaning beyond the literal content of utterances.",
            "Produce a spoken or written text that demonstrates authentic British register and tone.",
        ],
        default_weeks=1,
    ...
    CurriculumUnit(
        ...
        competency_checklist=[
            ...
            "Use advanced concessive structures (Much as..., For all..., Be that as it may) naturally.",
            "Use precise verbs of thought and argument (posit, contend, refute, problematise) accurately.",
            "Analyse the rhetorical strategy of a published speech or editorial.",
        ],
        default_weeks=1,
