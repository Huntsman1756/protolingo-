...
ASSESSMENT_BANK: list[AssessmentQuestion] = [
    ...
    AssessmentQuestion(
        ...
        skill="vocabulary",
        difficulty="B1",
        question='"He ___ he would come to the meeting but cancelled at the last minute." (made a definite commitment he did not keep)',
    ...
    AssessmentQuestion(
        ...
        skill="reading",
        difficulty="A2",
        question='Read: "Anna moved to Berlin two years ago. She works as a nurse and likes her job, but she misses her family in Spain." — Where does Anna\'s family live?',
        options=[
            "In Berlin",
            "In London",
            "In Spain",
    ...
    AssessmentQuestion(
        ...
        skill="reading",
        difficulty="A1",
        question='Read: "My name is Emma. I am eight years old. I live with my mum, dad, and sister." — How many people are in Emma\'s family?',
        options=["2", "3", "4", "5"],
        correct="4",
    ),
    AssessmentQuestion(
    ...
    AssessmentQuestion(
        ...
        skill="reading",
        difficulty="B1",
        question='Read: "The new shopping centre was supposed to open last spring, but construction delays have pushed the opening back to next year." — What is the main reason the shopping centre has not opened yet?',
        options=[
            "It ran out of money.",
    ...
    AssessmentQuestion(
        ...
        skill="reading",
        difficulty="B2",
        question='Read: "Critics have welcomed the new legislation as a bold step towards environmental accountability. Others, however, remain sceptical, arguing that without binding enforcement mechanisms, the law is little more than a symbolic gesture." — What is the main contrast in this passage?',
        options=[
    ...
    AssessmentQuestion(
        ...
        options=[
            ...
            "It subtly minimises the severity of events through word choice.",
            "It deliberately provokes the reader with shocking vocabulary.",
        ],
        correct="It subtly minimises the severity of events through word choice.",
    ),
    AssessmentQuestion(
        id="r-c1-004",
        skill="reading",
    ...
    AssessmentQuestion(
        ...
        question=(
            ...
            "becoming a convenient rationalisation for the underfunding of the arts. Necessity may be the mother of "
    ...
    AssessmentQuestion(
        ...
        skill="grammar",
        difficulty="B2",
        question="By the time the guests arrive, we ___ the dinner.",
    ...
    AssessmentQuestion(
        ...
        skill="vocabulary",
        difficulty="B2",
        question='"The two organisations decided to ___ their resources in order to reduce costs." (bring together for a shared purpose)',
    ...
    AssessmentQuestion(
        ...
        skill="vocabulary",
        difficulty="C1",
        question='"The minister\'s statement was ___ at best — she carefully avoided making any clear commitment."  (deliberately ambiguous to avoid commitment)',
    ...
    AssessmentQuestion(
        ...
        options=[
            ...
            "to criticise something publicly",
