...
B2_UNITS: list[CurriculumUnit] = [
    CurriculumUnit(
        ...
        grammar_points=["past-perfect", "be-to-future"],
    ...
    CurriculumUnit(
        ...
        level="B2",
        unit_number=4,
        title="Causative Have/Get, Modal Passive & Passive Infinitives",
        grammar_points=["advanced-passive", "passive-modals"],
    ...
    CurriculumUnit(
        ...
        grammar_points=["gerunds-infinitives", "phrasal-verbs-b2"],
    ...
    CurriculumUnit(
        ...
        vocabulary_set_ids=["academic_vocabulary_b2", "uk_institutions_b2"],
        lesson_types=["grammar", "vocabulary", "reading", "writing", "listening", "review"],
        competency_checklist=[
