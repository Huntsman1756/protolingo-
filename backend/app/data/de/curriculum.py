"""
DE curriculum — assembles all CEFR levels.
"""

from __future__ import annotations

from app.data._types import CEFRLevel, CurriculumUnit, LessonType  # noqa: F401
from app.data.de.curriculum_a1 import A1_UNITS
from app.data.de.curriculum_a2 import A2_UNITS
from app.data.de.curriculum_b1 import B1_UNITS
from app.data.de.curriculum_b2 import B2_UNITS
from app.data.de.curriculum_c1 import C1_UNITS
from app.data.de.curriculum_c2 import C2_UNITS
        ...
        slots.append(
            {
                ...
                "lesson_type": lt,
                "title": f"{unit.title} - Lektion {type_index + 1}",
    ...
    slots.append(
        {
            ...
            "unit_title": f"Niveautest {units[0].level}",
            "lesson_type": "review",
            "title": f"Niveautest {units[0].level}",
            "objectives": [
